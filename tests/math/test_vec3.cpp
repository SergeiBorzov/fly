...
TEST(Vec3, Constructors)
{
    ...
    EXPECT_NEAR(4.0f, d.x, HLS_MATH_EPSILON);
    EXPECT_NEAR(3.0f, d.y, HLS_MATH_EPSILON);
    EXPECT_NEAR(2.0f, d.z, HLS_MATH_EPSILON);
}
...
TEST(Vec3, Dot)
{
    ...
    EXPECT_NEAR(7.0f, Dot(b, c), HLS_MATH_EPSILON);
}
...
TEST(Vec3, Cross)
{
    ...
    EXPECT_NEAR(0.0f, z.x, HLS_MATH_EPSILON);
    EXPECT_NEAR(0.0f, z.y, HLS_MATH_EPSILON);
    EXPECT_NEAR(1.0f, z.z, HLS_MATH_EPSILON);
    ...
    EXPECT_NEAR(-3.0f, c.x, HLS_MATH_EPSILON);
    EXPECT_NEAR(6.0f, c.y, HLS_MATH_EPSILON);
    EXPECT_NEAR(-3.0f, c.z, HLS_MATH_EPSILON);
}
...
TEST(Vec3, Length)
{
    ...
    EXPECT_NEAR(3.0f, Length(b), HLS_MATH_EPSILON);
    EXPECT_NEAR(9.0f, LengthSqr(b), HLS_MATH_EPSILON);
}
...
TEST(Vec3, Normalize)
{
    ...
    EXPECT_NEAR(1.0f / 3.0f, b.x, HLS_MATH_EPSILON);
    EXPECT_NEAR(2.0f / 3.0f, b.y, HLS_MATH_EPSILON);
    EXPECT_NEAR(2.0f / 3.0f, b.z, HLS_MATH_EPSILON);
}
