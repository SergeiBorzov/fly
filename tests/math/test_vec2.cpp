...
TEST(Vec2, Constructors)
{
    ...
    EXPECT_NEAR(12.0f, vector2.x, FLY_MATH_EPSILON);
    EXPECT_NEAR(-34.0f, vector2.y, FLY_MATH_EPSILON);
    ...
    Vec2 b = Vec2(vec4);
    EXPECT_NEAR(-1.0f, b.x, FLY_MATH_EPSILON);
    EXPECT_NEAR(-2.0f, b.y, FLY_MATH_EPSILON);
}
...
TEST(Vec2, Dot)
{
    ...
    EXPECT_NEAR(0.0f, Dot(a, b), FLY_MATH_EPSILON);
    EXPECT_NEAR(-3.0f, Dot(a, c), FLY_MATH_EPSILON);
    EXPECT_NEAR(9.0f, Dot(b, c), FLY_MATH_EPSILON);
}
...
TEST(Vec2, Length)
{
    ...
    Vec2 b(3.0f, 4.0f);
    EXPECT_NEAR(5.0f, Length(b), FLY_MATH_EPSILON);
    EXPECT_NEAR(25.0f, LengthSqr(b), FLY_MATH_EPSILON);
}
...
TEST(Vec2, Normalize)
{
    ...
    EXPECT_NEAR(0.6f, b.x, FLY_MATH_EPSILON);
    EXPECT_NEAR(0.8f, b.y, FLY_MATH_EPSILON);
}
